...
#define OLED_SCLK_Clr() GPIO_ResetBits(GPIOB,GPIO_Pin_15)//SCL
#define OLED_SCLK_Set() GPIO_SetBits(GPIOB,GPIO_Pin_15)

#define OLED_SDIN_Clr() GPIO_ResetBits(GPIOB,GPIO_Pin_12)//SDA
#define OLED_SDIN_Set() GPIO_SetBits(GPIOB,GPIO_Pin_12)
